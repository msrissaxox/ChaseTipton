...
export default function Footer() {
    ...
    return (
        <div ref={ref} className={`flex flex-col md:flex-row justify-between items-center w-full text-center p-4 space-y-2 md:space-y-0 transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-100'}`}>
